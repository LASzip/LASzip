...
===============================================================================
  ...
  FILE:  laspointreader0compressedarithmetic.cpp
...
bool LASpointReader0compressedArithmetic::read_point(LASpoint* point, double* gps_time, unsigned short* rgb)
{
	if (dec)
	{
		*point = last_point;
...
LASpointReader0compressedArithmetic::LASpointReader0compressedArithmetic(FILE* file)
{
	this->file = file;
  last_dir = 0;
...
void LASpointReader0compressedArithmetic::init_decoder()
{
  ...
  ic_z->SetupDecompressor(dec, 33);
	...
	m_changed_values = new ArithmeticModel(64,0,0);
...
LASpointReader0compressedArithmetic::~LASpointReader0compressedArithmetic()
{
	if (dec)
	{
		dec->done();
