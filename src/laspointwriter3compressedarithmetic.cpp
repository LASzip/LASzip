...
===============================================================================
  ...
  FILE:  laspointwriter3compressedarithmetic.cpp
...
bool LASpointWriter3compressedArithmetic::write_point(LASpoint* point, double gps_time, unsigned short* rgb)
{
	if (enc)
	{
...
LASpointWriter3compressedArithmetic::LASpointWriter3compressedArithmetic(FILE* file)
{
	this->file = file;
  last_dir = 0;
...
void LASpointWriter3compressedArithmetic::init_encoder()
{
  ...
  ic_z->SetupCompressor(enc, 33);
	...
	m_changed_values = new ArithmeticModel(256,0,1);
...
LASpointWriter3compressedArithmetic::~LASpointWriter3compressedArithmetic()
{
	if (enc)
	{
		enc->done();
