...
===============================================================================
  ...
  FILE:  integercompressor_newest.h
...
===============================================================================
*/
#ifndef INTEGER_COMPRESSOR_NEWEST_H
#define INTEGER_COMPRESSOR_NEWEST_H
...
public:
  ...
  // SetupCompressor:
  void SetupCompressor(ArithmeticEncoder* enc, int contexts=1, int BITS_HIGH=8);
  ...
  // SetupDecompressor:
  void SetupDecompressor(ArithmeticDecoder* dec, int contexts=1, int BITS_HIGH=8);
...
private:
  // Private Functions
  I32 writeCorrector(I32 c, ArithmeticModel* mBits);
  ...
  ArithmeticModel* mBitsNone;
  ArithmeticModel** mBitsLast;
