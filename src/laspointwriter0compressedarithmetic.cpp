...
===============================================================================
  ...
  FILE:  laspointwriter0compressedarithmetic.cpp
...
bool LASpointWriter0compressedArithmetic::write_point(LASpoint* point, double gps_time, unsigned short* rgb)
{
	if (enc)
	{
...
LASpointWriter0compressedArithmetic::LASpointWriter0compressedArithmetic(FILE* file)
{
	this->file = file;
  last_dir = 0;
...
void LASpointWriter0compressedArithmetic::init_encoder()
{
...
LASpointWriter0compressedArithmetic::~LASpointWriter0compressedArithmetic()
{
	if (enc)
	{
		enc->done();
