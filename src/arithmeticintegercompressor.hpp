...
===============================================================================
  ...
  FILE:  arithmeticintegercompressorarithmetic.h
  ...
  CHANGE HISTORY:
    ...
    31 October 2009 -- switched from the Rangecoder to the Arithmeticcoder
...
===============================================================================
*/
#ifndef ARITHMETIC_INTEGER_COMPRESSOR_H
#define ARITHMETIC_INTEGER_COMPRESSOR_H
...
class ArithmeticIntegerCompressor
{
public:
  ...
  // SetupCompressor:
  void SetupCompressor(ArithmeticEncoder* enc, U32 contexts=1, U32 BITS_HIGH=8);
  ...
  // SetupDecompressor:
  void SetupDecompressor(ArithmeticDecoder* dec, U32 contexts=1, U32 BITS_HIGH=8);
  ...
  // Constructor:
  ArithmeticIntegerCompressor();
  // Destructor:
  ~ArithmeticIntegerCompressor();

private:
  // Private Functions
  void writeCorrector(I32 c, ArithmeticModel* mBits);
  I32 readCorrector(ArithmeticModel* mBits);
