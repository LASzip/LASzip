...
===============================================================================
  ...
  FILE:  rangeintegercompressor.cpp
...
RangeIntegerCompressor::RangeIntegerCompressor()
{
  bits = 16;
  range = 0;
...
void RangeIntegerCompressor::SetupCompressor(RangeEncoder* re, U32 contexts, U32 bits_high)
{
  U32 i;
  ...
  for (i = 1; i <= corr_bits; i++)
  {
    if (i <= bits_high)
    {
      rmCorrector[i] = new RangeModel((1<<i),0,1,2048,16);
    }
    else
    {
      rmCorrector[i] = new RangeModel((1<<bits_high),0,1,2048,16);
    }
  }
#endif
...
void RangeIntegerCompressor::FinishCompressor()
{
  U32 i;
  if (rmBits)
  {
...
void RangeIntegerCompressor::SetupDecompressor(RangeDecoder* rd, U32 contexts, U32 bits_high)
{
  U32 i;
  ...
  for (i = 1; i <= corr_bits; i++)
  {
    if (i <= bits_high)
    {
      rmCorrector[i] = new RangeModel((1<<i),0,0,2048,16);
    }
    else
    {
      rmCorrector[i] = new RangeModel((1<<bits_high),0,0,2048,16);
    }
  }
#endif
}

void RangeIntegerCompressor::FinishDecompressor()
{
  U32 i;
  if (rmBits)
  {
...
// writeCorrector:
//-----------------------------------------------------------------------------
void RangeIntegerCompressor::writeCorrector(I32 c, RangeModel* rmBits)
{
  I32 c1;
...
void RangeIntegerCompressor::Compress(I32 pred, I32 real, U32 context)
{
...
I32 RangeIntegerCompressor::readCorrector(RangeModel* rmBits)
{
  I32 c;
...
I32 RangeIntegerCompressor::Decompress(I32 pred, U32 context)
{
