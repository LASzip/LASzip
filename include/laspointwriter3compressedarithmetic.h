...
===============================================================================
  ...
  FILE:  laspointwriter3compressedarithmetic.h
...
===============================================================================
*/
#ifndef LAS_POINT_WRITER_3COMPRESSED_ARITHMETIC_H
#define LAS_POINT_WRITER_3COMPRESSED_ARITHMETIC_H
...
class LASpointWriter3compressedArithmetic : public LASpointWriter
{
public:
  bool write_point(LASpoint* point, double gps_time = 0, unsigned short* rgb = 0);
  LASpointWriter3compressedArithmetic(FILE* file);
  ~LASpointWriter3compressedArithmetic();
